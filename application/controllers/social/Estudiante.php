...
class Estudiante extends CI_Controller
{
  ...
  public function actintegrantes()
  {
    if($this->session->userdata('logged_in'))
    {
      $resultado['sesion']=$this->session->userdata('logged_in');
      $this->load->view('social/vista_estudiante_actividad',$resultado);
    }
    else
    {
      redirect('login', 'refresh');
  ...
  public function estu_listar($id=null)
  {
    $resultado = $this->Modelo_estudiante->estu_listar($id);
    $this->output->set_content_type('application/json')
    ->set_output(json_encode( $resultado ));
  }
  public function estu_listar_actividad($id=null)
  {
    $resultado = $this->Modelo_estudiante->estu_listar_actividad($id);
    $this->output->set_content_type('application/json')
    ->set_output(json_encode( $resultado ));
  }
