...
class Dashboard extends CI_Controller
{
  ...
  function __construct()
  {
    ...
    $this->load->model('social/Modelo_estadisticas');
  ...
  public function index()
  {
    if($this->session->userdata('logged_in'))
    {
      ...
      $this->load->view('social/vista_dashboard',$resultado);
    }
    else
    {
    ...
    {
      $resultado = $this->Modelo_estadisticas->estadisticas($id);
      $this->output->set_content_type('application/json')
      ->set_output(json_encode( $resultado ));
    }

    public function dinero_x_sede($id=null)
    {
      $resultado = $this->Modelo_estadisticas->dinero_x_sede($id);
      $this->output->set_content_type('application/json')
      ->set_output(json_encode( $resultado ));
    }


    public function ingresos_x_tipo($id=null)
    {
      $resultado = $this->Modelo_estadisticas->ingresos_x_tipo($id);
      $this->output->set_content_type('application/json')
      ->set_output(json_encode( $resultado ));
    }
