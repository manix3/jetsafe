    ...
    <main id="content" class="content" role="main">
        ...
        <div class="row"> <!-- Inicio tabla !-->
          ...
          <section class="widget">
                <header>
                    <h4>Tipo de <span class="fw-semi-bold">Moneda</span></h4>
                       <button type="button" class="btn btn-primary" id="btnNuevo">Nuevo Tipo de Moneda</button>
...
<script src="<?php echo base_url(); ?>js/coti/j_cot_vista_tip_moneda.js"></script>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Datos de Tipo de Moneda</h3>
...
<div class="modal fade" id="myModalborrar" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
  <div class="modal-dialog ">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h3 class="modal-title" id="">Eliminar Tipo de Moneda</h3>
      </div>
      <div class="modal-body">


        <p>¿Esta seguro de eliminar este Tipo de Moneda?</p>
