...
<html>
<head>
  <title>SMARTPYME - Cotizaciones</title>
    ...
    <main id="content" class="content" role="main">
        ...
        <div class="row"> <!-- Inicio tabla !-->
          ...
          <section class="widget">
                <header>
                    <h4><span class="fw-semi-bold">Cotizaciones</span></h4>
                       <a href="<?=base_url() ?>Cotizacion/Nueva"><button type="button" class="btn btn-primary" id="">Nueva Cotización</button></a>
...
<script src="<?php echo base_url(); ?>js/coti/j_cot_vista_list_coti.js"></script>
