    ...
    <main id="content" class="content" role="main">
        ...
        <div class="row"> <!-- Inicio tabla !-->
          ...
          <section class="widget">
                <header>
                    <h4>Estado de <span class="fw-semi-bold">Cotizacion</span></h4>
                       <button type="button" class="btn btn-primary" id="btnNuevo">Nuevo Estado de Cotizacion</button>
...
<script src="<?php echo base_url(); ?>js/coti/j_cot_vista_est_coti.js"></script>
