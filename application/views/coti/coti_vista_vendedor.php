...
<script src="<?php echo base_url(); ?>js/coti/j_cot_vista_vendedor.js"></script>
        ...
        <input id="accion" name="accion" class="form-control" placeholder="" readonly="true" value='xxx' type="hidden">
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input id="ven_doc" name="ven_doc" class="form-control" placeholder="" required="required" value='sss' type="text">
            ...
            <div class="form-group">
              <label for="normal-field" class="col-sm-4 control-label">Dirección</label>
              <div class="col-sm-8">
                <input id="ven_dir" name="ven_dir" class="form-control" placeholder=""  value='sss' type="text">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input id="ven_ruc" name="ven_ruc" class="form-control" placeholder=""  value='sss' type="text">
            ...
            <div class="form-group">
              <label for="normal-field" class="col-sm-4 control-label">Telefono 2/3</label>
              <div class="col-sm-4">
                <input id="ven_tel2" name="ven_tel2" class="form-control" placeholder=""  value='sss' type="text">

              </div>
              <div class="col-sm-4">
                <input id="ven_tel3" name="ven_tel3" class="form-control" placeholder=""  value='sss' type="text">
            ...
            <div class="form-group">
              <label for="normal-field" class="col-sm-4 control-label">Fecha Nacimiento</label>
              <div class="col-sm-8">
                <input id="ven_fecha_nac" name="ven_fecha_nac" class="form-control" placeholder=""  value='sss' type="date">
            ...
            <div class="form-group">
              <label for="normal-field" class="col-sm-4 control-label">Facebook /  Twitter</label>
              <div class="col-sm-4">
                <input id="ven_facebook" name="ven_facebook" class="form-control" placeholder=""  value='sss' type="text">

              </div>
              <div class="col-sm-4">
                <input id="ven_twitter" name="ven_twitter" class="form-control" placeholder=""  value='sss' type="text">

              </div>
            </div>

            <div class="form-group">
              <label for="normal-field" class="col-sm-4 control-label">Glosa</label>
              <div class="col-sm-8">
                <textarea id="ven_gls" name="ven_gls" class="form-control" placeholder=""  value='sss' type="text"></textarea>
              </div>
            </div>
  ...
  <div class="modal-dialog ">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>¿Esta seguro de eliminar este Vendedor?</p>
