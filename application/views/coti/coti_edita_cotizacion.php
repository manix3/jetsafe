...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
      ...
      <h3 class="page-title">Editar <span class="fw-semi-bold">Cotización</span></h3>
                      ...
                      <div class="col-md-6">
                        <fieldset>
                          ...
                          <div class="form-group formsinmargen">
                            ...
                            <div class="col-sm-8">
                              <input type="text" placeholder="Prefijo" id="prefijo" name="prefijo" class="form-control"required="required"  value="<?=  $coti[0]->prefijo ?> ">
                            </div>
                          </div>
                          <div class="form-group formsinmargen">
                            <label for="hint-field" class="col-sm-4 control-label">
                            ...
                            <div class="col-sm-8">
                              <input type="text" placeholder="Serie" id="serie" name="serie" class="form-control" required="required"  value="<?=  $coti[0]->serie ?>">
                            </div>
                          </div>
                          <div class="form-group formsinmargen">
                            <label for="hint-field" class="col-sm-4 control-label">
                            ...
                            <div class="col-sm-8">
                              <input type="number" placeholder="Numero" id="numero" name="numero" class="form-control" required="required" value="<?=  $coti[0]->numero ?>">
                            </div>
                          </div>
                        </fieldset>
                      </div>
                      <div class="col-md-6">
                        <fieldset>
                          ...
                          <div class="form-group formsinmargen">
                            ...
                            <div class="col-sm-8">
                              <input type="date" placeholder="" id="fecha_ini" name="fecha_ini" class="form-control"required="required" value="<?=  $coti[0]->fecha ?>" >
                            </div>
                          </div>
                          <div class="form-group formsinmargen">
                            <label for="hint-field" class="col-sm-4 control-label">
                            ...
                            <div class="col-sm-8">
                              <input type="date" placeholder="" id="fecha_fin" name="fecha_fin" class="form-control" required="required" value="<?=  $coti[0]->fecha_vencimiento ?>">
                            </div>
                          </div>
                          <div class="form-group formsinmargen">
                            <label for="hint-field" class="col-sm-4 control-label">
                            ...
                            <div class="col-sm-8">
                              <input type="text" placeholder="Glosa" id="glosa" name="glosa" class="form-control"  value="<?=  $coti[0]->gls_cotizacion ?>">
                            </div>
                          </div>
                        </fieldset>
                      </div>
                            ...
                            <fieldset>
                              <div class="form-group formsinmargen">
                                ...
                                <div class="col-sm-8" id="nombre_cli">
                                    ...
                                    <input type="text" readonly="readonly" name="nom_cli" value="<?= $coti[0]->cli_nombre ?>" class="form-control" id="nom_cli"  >
                                 </div>
                              ...
                              <span class="help-block">Apellidos de  cliente</span>
                                ...
                                <div class="col-sm-4">
                                  <input readonly="true" type="text" placeholder="Apellido Paterno" id="inp_ape_pat" name="inp_ape_pat" class="form-control" required="required" data-parsley-id="20" value="<?=  $coti[0]->cli_nombre ?>">
                                </div>
                                <div class="col-sm-4 margensup">
                                  <input readonly="true" type="text" placeholder="Apellido Materno" id="inp_ape_mat" name="inp_ape_mat" class="form-control" data-parsley-id="22" value="<?=  $coti[0]->cli_nombre ?>">
                                </div>
                              </div> -->
                              <!-- <div class="form-group formsinmargen">
                                <label for="hint-field" class="col-sm-4 control-label">
                              ...
                              <div class="form-group formsinmargen">
                                ...
                                <div class="col-sm-8">
                                  <input readonly="true" type="email" placeholder="Ingrese su Correo" id="mail" name="mail" class="form-control" required="required" data-parsley-id="30" value=" <?=  $coti[0]->email_destino ?>">
                                </div>
                              </div>
                            </fieldset>
                          </form>
                        ...
                        <div class="col-md-6">
                          <fieldset>
                            <div class="form-group formsinmargen">
                              ...
                              <div class="col-sm-8">
                                <input readonly="true" type="text" placeholder="" id="ruc" name="ruc" class="form-control" value="<?=  $coti[0]->cli_ruc ?>">
                              </div>
                            </div>
                            <div class="form-group formsinmargen">
                              <label for="hint-field" class="col-sm-4 control-label">
                              ...
                              <div class="col-sm-8">
                                <input readonly="true" type="text" placeholder="Ingrese Direccion Cliente" id="dir" name="dir" class="form-control" required="required" data-parsley-id="24" value="<?=  $coti[0]->cli_direccion ?>">
                              </div>
                            ...
                            <div class="form-group formsinmargen">
                              ...
                              <div class="col-sm-8">
                                <input readonly="true" type="tel" placeholder="Ingrese telefono 1" id="inp_tel_cli1" name="inp_tel_cli1" class="form-control" required="required" data-parsley-id="26" value="<?=  $coti[0]->telefono_destino ?>">
                              </div>
                              <!-- <div class="col-sm-4 margensup">
                    ...
                    <form id="form_prod" class="" action="" method="post">
                      <fieldset>
                        <div class="form-group">
                          <div class="col-lg-6">
                            <select class="select2 form-control input-lg" id="list_prod_u" name="list_prod_u" >
                            </select>
                          ...
                          <div class="col-lg-2">
                            <input type="number" min="1" class="form-control input-lg" placeholder="Cantidad" id="cant" value="1">
                          </div>
      ...
      <div class="row">
          <div class="col-md-12">
              <section class="widget" >
                ...
                <div class="row">
                  <br>
                  <button type="button" class="btn btn-success btn-block" name="button" id="do">Facturar</button>
                  <br>
                </div>
              </section>
          </div>
...
var coti;
var pantalla="";
var ide_cotu = '<?=$this->uri->segment(4)?>';
...
$(document).ready(function() {
  $.post(Gruta+'coti/Cot_cotizacion/cot_listar/<?=$this->uri->segment(4) ?>',function (data) {
      coti  = data[0];
      
      comboselect(coti.ide_est_cot,Gruta+'coti/Cot_mantenimiento/est_Coti_listar','Seleccione Estado','item.ide_est_cot','item.det_est_cot','form_coti','est_coti');
      comboselect(coti.ide_tip_mon,Gruta+'coti/Cot_mantenimiento/tip_Mon_listar','Seleccione Moneda','item.ide_tip_mon','item.detalle_tip_mon','form_coti','ide_tip_moneda');



                  $.each(coti.items, function (i,item) {
                      pantalla+=`
                          <div class="row">
                          <div class="col-lg-4">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group">
                                    <span class="input-group-addon">${coti.sim_moneda}</span>
                                      <input class="form-control"  type="number" placeholder="Precio" value="${item.cot_precio}" readonly="true">
                                  </div>
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="input-group">
                                  <span class="input-group-addon"><i class="fa fa-cubes"></i></span>
                                    <input class="form-control cant"  min="1" type="number" placeholder="Cantidad" id="${item.ide_producto}" value="${item.cot_cantidad}" >
                                </div>

                            </div>
                            <div class="col-lg-2">
                            <input class="form-control"  type="hidden" value="${item.ide_producto}">
                      ...
                      prod = {
                        ide_producto:item.ide_producto,
                        cot_cantidad:parseFloat(item.cot_cantidad),
                        cot_precio: parseFloat(item.cot_precio),
                      }
  ...
  $('#L_Productos').on('change', '.cant',function () {
      var id = $(this).attr('id');
      var cant = $(this).val();
      ...
      $.each(lista.productos,function (i,item) {
        ...
        console.log(item.ide_producto);
        if (item.ide_producto == _that.attr('id')) {
          console.log(_that.attr('id'), _that.val() );
          _that.val(item.cot_cantidad);

          }

        // var pre = parseFloat(coti.items[i].cot_precio) * parseFloat(item.cot_cantidad);
              pantalla+=`
                  <div class="row">
                  <div class="col-lg-4">
                    <input class="form-control " id="" name="list_prod_u" readonly="true" value="${coti.items[i].nom_prod}">
                    </div>
                    <div class="col-lg-2">
                      <div class="input-group">
                            <span class="input-group-addon">${coti.sim_moneda}</span>
                              <input class="form-control"  type="number" placeholder="Precio" value="${parseFloat(item.cot_precio)}" readonly="true">
                          </div>
                    </div>
                    <div class="col-lg-2">
...
<script src="<?php echo base_url(); ?>js/propios.js"></script>
<script src="<?php echo base_url(); ?>js/coti/j_cot_vista_edita_coti.js"></script>
