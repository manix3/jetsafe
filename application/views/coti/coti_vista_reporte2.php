          ...
          <section class="widget">
            ...
            <div id="reportrange" align="right" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 0px solid #ccc; width: 50%">
               ...
               <span id="datofecha" name="datofecha"></span> <b class="caret"></b>
                ...
                <header>
                    <h4><span class="fw-semi-bold">Reporte de Actividad de seguimientos</span></h4>
...
$('#reportrange').on('apply.daterangepicker', function(ev, picker) {
  ...
  console.log($('#datofecha').text());
  rangofecha=$('#datofecha').text();
  //alert(xxx);
  $('#datatable-table').dataTable().fnDestroy();

jalar_data(rangofecha);
  //$('#daterange').val('');
});
...
<script src="<?php echo base_url(); ?>js/coti/j_cot_vista_reporte2.js"></script>
