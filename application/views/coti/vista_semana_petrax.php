...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <h3 class="page-title">Mes: <span class="fw-semi-bold" id="monthWeek"></span> <div class="pull-right">Semana: <span class="fw-semi-bold" id="numweek"></span></div></h3>
          <div class="divTableRow" id="divTableRow">
            <div class="arrow-buttons" style="font-size: 30px;border: none;" > <button type="button" name="button" class="btn btn-warning" style="border-radius: 153px;" id="prev"  ><span class="glyphicon glyphicon-chevron-left"></span></button></div>
            <div class="div-flex widget" id="dayWeekDiv-1">
              <div class="col-md-12 sem-day">
                  LUN
              </div>
              <div class="col-md-12 ">
                  <div class="col-md-6"></div>
                  <div class="col-md-6 sem-numb-day"> <span id="dayWeek-1"></span> </div>
              </div>
            </div>
            <div class="div-flex widget" id="dayWeekDiv-2">
              <div class="col-md-12 sem-day">
                  MAR
              </div>
              <div class="col-md-12 ">
                  <div class="col-md-6"></div>
                  <div class="col-md-6 sem-numb-day"> <span id="dayWeek-2"></span> </div>
              </div>
            </div>
            <div class="div-flex widget" id="dayWeekDiv-3">
              <div class="col-md-12 sem-day">
                  MIE
              </div>
              <div class="col-md-12 ">
                  <div class="col-md-6"></div>
                  <div class="col-md-6 sem-numb-day"> <span id="dayWeek-3"></span> </div>
              </div>
            </div>
            <div class="div-flex widget" id="dayWeekDiv-4">
              <div class="col-md-12 sem-day">
                  JUE
              </div>
              <div class="col-md-12 ">
                  <div class="col-md-6"></div>
                  <div class="col-md-6 sem-numb-day"> <span id="dayWeek-4"></span> </div>
              </div>
            </div>
            <div class="div-flex widget" id="dayWeekDiv-5">
              <div class="col-md-12 sem-day">
                  VIE
              </div>
              <div class="col-md-12 ">
                  <div class="col-md-6"></div>
                  <div class="col-md-6 sem-numb-day"> <span id="dayWeek-5"></span> </div>
              </div>
            </div>
            <div class="div-flex widget" id="dayWeekDiv-6">
              <div class="col-md-12 sem-day">
                  SAB
              </div>
              <div class="col-md-12 ">
                <div class="col-md-6"></div>
                <div class="col-md-6 sem-numb-day"> <span id="dayWeek-6"></span> </div>
              </div>
            </div>
            <div class="div-flex widget" id="dayWeekDiv-7">
              <div class="col-md-12 sem-day">
                  DOM
              </div>
              <div class="col-md-12 ">
                  <div class="col-md-6"></div>
                  <div class="col-md-6 sem-numb-day"> <span id="dayWeek-7"></span> </div>
              </div>
            </div>
            <div class="arrow-buttons" style="font-size: 30px;border: none;" > <button type="button" name="button" class="btn btn-warning" style="border-radius: 153px;" id="next" ><span class="glyphicon glyphicon-chevron-right"></span></button></div>
          </div>
        </div>
      </div>
        ...
        <div class="row"> <!-- Inicio tabla !-->
          ...
          <section class="widget">
                <header>
                    <h4><span class="fw-semi-bold">Seguimiento Clientes</span></h4>
                       <a href="<?=base_url() ?>Cotizacion/Nueva"><button type="button" class="btn btn-primary" id="">Nuevo Seguimiento</button></a>
                      ...
                      <table id="datatable-table" class="table table-striped table-hover d-none ">
                        <thead>
                          <tr>
                            ...
                            <th class="hidden-xs" width="50px">Empresa</th>
                                    <th class="hidden-xs">RUC</th>
                            <th class="hidden-xs">Gls</th>
                              <th class="hidden-xs">Contacto</th>
                            <th class="hidden-xs">Cargo</th>
                            <th class="hidden-xs">Telefono</th>
                            <th class="hidden-xs">Email</th>
                            <th class="hidden-xs">Ult Cont</th>
                            <th class="hidden-xs">Prx Cont</th>
...
<script src="<?php echo base_url(); ?>js/coti/j_cot_vista_list_segu.js"></script>
<script src="<?php echo base_url(); ?>js/coti/j_vista_semanario.js"></script>
