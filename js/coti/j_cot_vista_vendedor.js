$(function(){
  ...
  $('#myModalver #myModaleditaLabel').html('Datos Vendedor');
    ...
    $.getJSON(Gruta+'coti/cot_vendedor/ven_list/'+idr, function(data) { // Inicio JSON
      $.each(data, function(k,item){
        det_registro+=`
        <tr><th>Id: </th> <td>${item.ide_vendedor}</td></tr>
        ...
        <tr><th>Documento </th><td>${item.ven_doc}</td></tr>
        <tr><th>Dirección </th><td>${item.ven_dir}</td></tr>
        <tr><th>Ruc </th><td>${item.ven_ruc}</td></tr>
        <tr><th>Telefono 1 </th><td>${item.ven_tel1}</td></tr>
        <tr><th>Telefono 2  </th><td>${item.ven_tel2}</td></tr>
        <tr><th>Telefono 3 </th><td>${item.ven_tel3}</td></tr>
        <tr><th>Email </th><td>${item.ven_email}</td></tr>
        <tr><th>Glosa </th><td>${item.ven_gls}</td></tr>
        <tr><th>Fecha</th><td>${item.ven_fecha_nac}</td></tr>
        <tr><th>Facebook </th><td>${item.ven_facebook}</td></tr>
        <tr><th>Twitter</th><td>${item.ven_twitter}</td></tr>
        `;
      });
